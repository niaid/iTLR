    ...
    **/
    ...
    _chart._generateG = function (parent) {
        ...
        _chartBodyG = _g.append('g').attr('class', 'chart-body')
            .attr('transform', 'translate(' + (_chart.margins().left+6) + ', ' + _chart.margins().top + ')')
    ...
    **/
    ...
    _chart.renderXAxis = function (g) {
        ...
        if (axisXG.empty()) {
            axisXG = g.append('g')
                .attr('class', 'axis x')
                .attr('transform', 'translate(' + (_chart.margins().left+6) + ',' + _chart._xAxisY() + ')');
        }
    ...
    _chart.renderYAxisAt = function (axisClass, axis, position) {
        ...
        if (axisYG.empty()) {
            axisYG = _chart.g().append('g')
                ...
                .attr('transform', 'translate(' + (position+6) + ',' + _chart.margins().top + ')');
        }
